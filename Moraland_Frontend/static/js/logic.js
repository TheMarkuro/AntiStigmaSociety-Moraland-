...
const serverUrl = "https://8ietganijdr6.usemoralis.com:2053/server";
const appId = "x2CDMNk84zW13t9ijxzALKUzWAdkOUharolqf31w";
...
const mainCanvas = document.getElementById("mainCanvas"); //loading canvas from html doc
const mainCtx = mainCanvas.getContext('2d'); //not 3d, x and y coordinates only
const plotCanvas = document.getElementById("plotCanvas");
const plotCtx = plotCanvas.getContext('2d');
const worldImage = new Image(); //drawing the image
...
//web3 constants
const contractAddress = "0xf054323A6A13952FDd8A388f63f223bAe4015f83"; //your own contract
...
//animate functions - for moving around the map
...
//disables the claiming buttong for unassignable or restricted areas/plots
...
//putting the data into the IPFS
...
//checking if the plot has been bought via metamask
